...
a persistence unit "evaluacionJakartaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "evaluacionJakarta/pom.xml":
...
artifact ("evaluacionJakarta.war") is already built. You can build
